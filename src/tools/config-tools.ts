...
export function registerConfigTools(
  ...
  server.registerTool(
    "delete-configuration",
    {
      ...
      description:
        "Delete a configuration element from VCF Automation Orchestrator. This action is irreversible. Set confirm to true to proceed. Set force to true to delete an element vRO reports as in use.",
      inputSchema: z.object({
