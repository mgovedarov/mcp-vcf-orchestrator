...
1. Configure `VCFA_HOST`, `VCFA_USERNAME`, `VCFA_ORGANIZATION`, and `VCFA_PASSWORD`. Artifacts are written to `artifacts/` in the repository root by default; set `VCFA_ARTIFACT_DIR` to override.
