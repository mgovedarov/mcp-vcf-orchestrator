...
2. Verify access with read-only discovery: `list-plugins`, `list-categories`, `list-workflows`, `list-actions`, `list-projects`, `list-templates`, `list-catalog-items`, `list-event-topics`, and `list-subscriptions`.
