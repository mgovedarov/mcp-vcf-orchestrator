...
- **Blueprint-service and event-broker writes: supported.** `create-template`, `delete-template`, and the subscription create/update/delete tools were verified against a vRA 8.18 lab under VCFO-070 with a disposable DRAFT template and a disposable disabled subscription; neither provisions infrastructure.
