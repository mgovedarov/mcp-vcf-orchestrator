...
- Catalog and deployments: `list-catalog-items`, `get-catalog-item`, `list-deployments`, `get-deployment`, `get-deployment-request`, `create-deployment`, `delete-deployment`, `list-deployment-actions`, `run-deployment-action`
